...
public class CenterLeftBallAuto extends SequentialCommandGroup {
  /** Creates a new CenterBallAuto. */
  public CenterLeftBallAuto(Drivetrain m_drivetrain, Climber m_climber, IntakeShooter m_intakeShooter) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new DriveStraightMM(m_drivetrain, 41),
      ...
      new DriveStraightMM(m_drivetrain, 76),
