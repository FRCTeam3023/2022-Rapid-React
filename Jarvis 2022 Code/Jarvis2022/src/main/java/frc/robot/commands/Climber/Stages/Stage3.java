...
public class Stage3 extends SequentialCommandGroup {
  /** Creates a new Stage3. */
  public Stage3(Climber m_climber) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetClimberPos(150000, Constants.CLIMBER_MAX_PIVOT, true, m_climber),
      new SetClimberPos(150000, Constants.CLIMBER_MIN_PIVOT, true, m_climber),
      new SetClimberPos(0, Constants.CLIMBER_MIN_PIVOT, true, m_climber),
      new SetClimberPos(0, -6150, true, m_climber),
